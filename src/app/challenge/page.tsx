            ...
            <FadeIn>
              <div className="bg-[var(--black)] text-white rounded-2xl p-8 md:p-10 mb-8">
                ...
                <div className="grid grid-cols-2 gap-6">
                  {[
                    { icon: "🎓", title: "OT + 3시간 특강", desc: "제이씨드가 직접 진행하는 릴코노미 핵심 강의" },
                    { icon: "🎟", title: "릴코노미 할인권", desc: "릴코노미 강의 할인권 증정" },
                    { icon: "✍️", title: "릴스크립트 1개월", desc: "릴스크립트 무제한 사용" },
                    { icon: "🤝", title: "오프라인 모임 1회", desc: "미션 달성 시 참가비 1만원 무료" },
                  ].map((item) => (
                    <div key={item.title}>
            ...
            <FadeIn>
              <div className="bg-gradient-to-br from-[var(--gray-900)] to-[var(--gray-800)] text-white rounded-2xl p-8 md:p-10 mb-8 relative overflow-hidden">
                ...
                <div className="relative">
                  <div className="text-xs font-semibold tracking-[0.15em] text-[var(--gray-500)] mb-4">OFFLINE MEETUP</div>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <FadeIn>
                <div className="bg-white rounded-2xl p-8 h-full border border-[var(--gray-200)] hover:-translate-y-1 transition-transform">
                  <div className="text-xs font-mono text-[var(--gray-400)] mb-3">OPTION A</div>
                  <div className="text-4xl font-[800] text-[var(--black)] mb-1">10만원</div>
                  <div className="text-sm text-[var(--gray-500)] mb-6">1:1 피드백 코스</div>
              ...
              <FadeIn delay={150}>
                <div className="bg-[var(--black)] text-white rounded-2xl p-8 h-full hover:-translate-y-1 transition-transform relative overflow-hidden">
                  ...
                  <div className="text-xs font-mono text-[var(--gray-500)] mb-3">OPTION B</div>
                  <div className="text-4xl font-[800] mb-1">20만원</div>
                  <div className="text-sm text-[var(--gray-400)] mb-6">1:1 맞춤 컨설팅 코스</div>
              ...
              <div className="bg-white rounded-2xl border border-[var(--gray-200)] p-8 mb-8">
                ...
                <div className="space-y-4">
                  <div className="flex gap-4 items-start">
                    ...
                    <div>
                      <h4 className="font-bold text-[var(--black)] text-sm">제이씨드(@jseed_money)</h4>
                      <p className="text-xs text-[var(--gray-500)]">주 1회 피드백</p>
                    </div>
                  </div>
                  <div className="flex gap-4 items-start">
                    <span className="text-2xl">🕵️</span>
                    <div>
                      <h4 className="font-bold text-[var(--black)] text-sm">스페셜 코치</h4>
                      <p className="text-xs text-[var(--gray-500)]">주 2~3회 랜덤 피드백</p>
                    </div>
                  </div>
                  <div className="flex gap-4 items-start">
                    <span className="text-2xl">👥</span>
                    <div>
                      <h4 className="font-bold text-[var(--black)] text-sm">릴뿌 동기끼리 피드백</h4>
                      <p className="text-xs text-[var(--gray-500)]">서로 대본, 편집, 디자인 피드백 · 댓글/좋아요 품앗이로 함께 성장</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <FadeIn delay={200}>
              <div className="bg-[var(--gray-900)] rounded-2xl p-8 md:p-12 text-center">
                ...
                <div className="grid grid-cols-3 gap-3 mb-8">
                  ...
                  <div className="bg-[var(--gray-800)] rounded-xl p-4">
                    <div className="text-xs text-[var(--gray-500)] mb-1">형식</div>
                    <div className="text-sm font-bold text-white">릴스/캐러셀</div>
                  </div>
                </div>
